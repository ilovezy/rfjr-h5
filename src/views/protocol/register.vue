    ...
    <section class="protocol-group">
      <div class="protocol-body">
        ...
        <div class="protocol-info protocal-main">
          <p>
            No.1、关于平台：朗润金融是为用户提供系统软件服务、账户资金和交易风险保证金监督及交易信息咨询的第三方服务机构。用户根据参与规则，通过朗润金融官方网站注册帐号，熟悉认可《交易规则》签订《服务协议书》，并支付交易风险保证金，获取出资方免息授信期货实盘操
          ...
          <p> No.21、参与规则完善申明
            本规则解释权归属朗润金融，同时金发金融保留对参与规则进行必要的变更和完善，并力求
            通过网站提前给予发布。</p>
          <p>  期市有风险，投资需谨慎！</p>
        </div>
      </div>
